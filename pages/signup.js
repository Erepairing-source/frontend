...
export default function Signup({ user, setUser }) {
  ...
  const validateStep = (stepNum) => {
    if (stepNum === 1) {
      ...
      if (!formData.admin_name || !formData.admin_email || !formData.admin_phone) {
        alert('Please fill in admin name, email, and phone')
        return false
      }
  ...
  const handleSubmit = async (e) => {
    ...
    if (!submitData.admin_password || !String(submitData.admin_password).trim()) {
      ...
      <header className="fixed top-0 left-0 right-0 z-40 bg-white/90 backdrop-blur border-b border-gray-200">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <Link href="/customer-signup" className="text-sm font-medium text-gray-600 hover:text-gray-900">
              I&apos;m a customer
            </Link>
          ...
          {step === 2 && (
            <div>
              ...
              <div className="space-y-6">
                ...
                <p className="text-sm text-gray-500 mt-2">If you leave password blank, we will email you a one-time link to set your password. The link expires after use.</p>
              </div>
                    ...
                    return (
                      ...
                      >
                        <div className="text-center">
                          ...
                          <p className="text-xs text-gray-500 -mt-2 mb-3">+18% GST</p>
                          {plan.description && (
