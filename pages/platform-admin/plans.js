...
export default function PlansPage() {
  ...
  const loadPlans = () => {
    ...
    fetch(getApiBase() + '/platform-admin/plans', {
  ...
  const handleSavePlan = async (planData) => {
    ...
    try {
      const url = selectedPlan
        ? `${getApiBase()}/platform-admin/plans/${selectedPlan.id}`
        : getApiBase() + '/platform-admin/plans'
  ...
  const handleDeletePlan = async (planId) => {
    ...
    try {
      const response = await fetch(`${getApiBase()}/platform-admin/plans/${planId}`, {
        method: 'DELETE',
        headers: { 'Authorization': `Bearer ${token}` }
      })
  ...
  const handleTogglePlanStatus = async (plan) => {
    ...
    try {
      const response = await fetch(`${getApiBase()}/platform-admin/plans/${plan.id}`, {
        method: 'PUT',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
