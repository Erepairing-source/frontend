...
export default function RegisterDevice() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        useUploadEndpoint
          ? (getApiBase()) + '/devices/register-with-files'
          : (getApiBase()) + '/devices/',
        useUploadEndpoint
          ? {
              method: 'POST',
  ...
  const handleBulkSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch((getApiBase()) + '/devices/bulk-register', {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`
        },
  ...
  const handleQrDecode = async () => {
    ...
    try {
      ...
      const response = await fetch((getApiBase()) + '/devices/qr-decode', {
        method: 'POST',
